...
8. Routing map: which folders/globs map to text-and-copy-editor / visual-polish / architecture-auditor. Note which tasks should just use the built-in Explore (read-only) or opusplan (planning).
